...
<article class="intel-container">
  ...
  <section>
    ...
    <ul class="metric-list">
        <li><strong>Olympic-Standard Amenities:</strong> Grandview Heights Aquatic Centre (opened 2016) is a 10-lane FINA-certified competition pool. If your kids swim competitively, this facility rivals anything in Metro Vancouver.</li>
        <li><strong>New Schools:</strong> Grandview Heights Secondary (opened 2021, 1,500-student capacity), Ta'talu Elementary (opened 2024), Pacific Heights Elementary, Edgewood Elementary. All modern facilities with up-to-date programming.</li>
    ...
    <ul class="metric-list">
        <li>You want established, mature neighbourhoods with 50-year-old trees (see Elgin Chantrell or Ocean Park)</li>
        <li>You're downsizing and don't need 4,000+ square feet</li>
        <li>You want walkable village living (see Ocean Park)</li>
        <li>You want multi-acre estate privacy (see Panorama Ridge)</li>
        <li>You prefer golf course or ocean views over suburban infrastructure</li>
    </ul>

    <h2 class="section-title">Grandview Heights vs The Competition</h2>
    <ul class="metric-list">
        <li><strong>vs Morgan Creek:</strong> Morgan Creek gives you golf course views and lock-and-go strata living in a fully built-out neighbourhood. Grandview Heights gives you new custom builds and Olympic-standard facilities in a growing area. Morgan Creek is established. Grandview Heights is evolving.</li>
        <li><strong>vs Elgin Chantrell:</strong> Elgin Chantrell gives you top school catchment and larger lots (12,000 sq ft to 1 acre). Grandview Heights gives you newer builds and modern amenities. Elgin Chantrell is for executive families prioritizing schools. Grandview Heights is for families prioritizing new construction.</li>
        <li><strong>vs Ocean Park:</strong> Ocean Park gives you beach village walkability and coastal character. Grandview Heights gives you modern suburban infrastructure and new builds. Ocean Park is for downsizers and lifestyle buyers. Grandview Heights is for growing families.</li>
    </ul>

    <h2 class="section-title">The Growth Reality</h2>
    <p>Grandview Heights is still developing. Active Neighbourhood Concept Plan (NCP) areas include Darts Hill (1,416 units approved), Redwood Heights, and Grandview Heights Area 5. That means the neighbourhood will continue to grow over the next 5-10 years. More homes. More amenities. More infrastructure.</p>
    <p>For some buyers, that's a positive (the area is improving and maturing). For others, it's a negative (construction noise, evolving character). Value here is driven by new construction quality and proximity to modern infrastructure (aquatic centre, schools, retail). As long as families prioritize new builds over character homes, Grandview Heights will hold demand.</p>
