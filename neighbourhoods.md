---
layout: default
title: Surrey Neighbourhood Real Estate Portfolio | Tanvir Bhupal
description: Strategic analysis of Surrey's premium enclaves. Expert intelligence on Elgin Chantrell, Ocean Park, Morgan Creek, Panorama Ridge, and Fraser Heights.
permalink: /neighbourhoods/
---

<section style="padding: 80px 10%; background: #fdfcf9;">
  <div style="max-width: 1000px; margin: 0 auto;">
    <h1 style="font-size: 3rem; font-weight: normal; color: #1a1a1a; margin-bottom: 10px;">The Neighbourhood Portfolio</h1>
    <p style="color: #666; margin-bottom: 60px; font-size: 1.1rem; font-style: italic;">Strategic enclaves analysed for lifestyle fit, school trajectory, and long-term equity protection.</p>
